...
public static class AndroidInputDescriptors
{
    ...
    public static InputDeviceDescriptor Touch(int androidDeviceId = VirtualDeviceId, string? displayName = null,
        bool supportsPressure = false, int maximumContacts = 0) =>
        new(InputDeviceId.FromOpaqueValue("android:touch:" + androidDeviceId.ToString(CultureInfo.InvariantCulture)),
            InputKind.Touch, displayName ?? "Android touch screen", InputDeviceAvailability.Available,
            BuildCapabilities(
    ...
    public static InputDeviceDescriptor Pen(int androidDeviceId = VirtualDeviceId, string? displayName = null,
        bool supportsPressure = true, bool supportsTilt = false,
        bool supportsEraser = false) =>
        new(InputDeviceId.FromOpaqueValue("android:pen:" + androidDeviceId.ToString(CultureInfo.InvariantCulture)),
            InputKind.Pen, displayName ?? "Android stylus", InputDeviceAvailability.Available,
            BuildCapabilities(
                ("android.device-id", androidDeviceId.ToString(CultureInfo.InvariantCulture)),
    ...
    public static InputDeviceDescriptor Keyboard(int androidDeviceId = VirtualDeviceId,
        string? displayName = null, bool isPhysical = false) =>
        new(InputDeviceId.FromOpaqueValue("android:keyboard:" + androidDeviceId.ToString(CultureInfo.InvariantCulture)),
            InputKind.Keyboard, displayName ?? (isPhysical ? "Android hardware keyboard" : "Android keyboard"),
    ...
    public static InputDeviceDescriptor Text(string? displayName = null) =>
        new(InputDeviceId.FromOpaqueValue("android:text:ime"), InputKind.Keyboard,
            displayName ?? "Android input method", InputDeviceAvailability.Available,
            BuildCapabilities(
