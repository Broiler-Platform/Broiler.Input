...
{
    public CameraSessionOptions(InputDeliveryOptions? deliveryOptions = null,
        CameraFrameDeliveryMode deliveryMode = CameraFrameDeliveryMode.LatestFramePreview,
        bool reportFormatChanges = true, bool reportDiscontinuities = true)
    {
    ...
    public static CameraSessionOptions LossSensitiveDefault { get; } =
        new(new InputDeliveryOptions(4, InputDeliveryOverflowPolicy.DropNewest), CameraFrameDeliveryMode.LossSensitive);
}
