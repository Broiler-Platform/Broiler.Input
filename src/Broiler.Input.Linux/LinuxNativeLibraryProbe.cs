...
public sealed record LinuxInputNativeLibraryRequirement(string Id, string DisplayName,
    IReadOnlyList<string> LibraryNames, bool Required = true);

public sealed record LinuxInputNativeLibraryStatus(string Id, string DisplayName, IReadOnlyList<string> LibraryNames,
    bool IsAvailable, string? LoadedLibraryName, string Diagnostic);
...
public static class LinuxInputNativeLibraryProbe
{
    ...
    public static IReadOnlyList<LinuxInputNativeLibraryStatus> CheckBaseline() => [Check(Udev)];
    ...
    public static LinuxInputNativeLibraryStatus Check(LinuxInputNativeLibraryRequirement requirement)
    {
        ...
        return new LinuxInputNativeLibraryStatus(requirement.Id, requirement.DisplayName,
            requirement.LibraryNames, IsAvailable: false, LoadedLibraryName: null,
