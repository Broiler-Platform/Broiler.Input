...
public sealed class WindowsMicrophoneProvider(IInputClock? clock = null, IInputDiagnosticSink? diagnostics = null) : IMicrophoneInputProvider, IInputDeviceWatcher
{
